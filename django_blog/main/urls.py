...
urlpatterns = [
    ...
    path('topics/<int:topic>/subscribe/', subscribe_topic, name='subscribe'),
    path('topics/<int:topic>/unsubscribe/', unsubscribe_topic, name='unsubscribe'),
    path('profile/<str:username>/', show_user_profile, name='username'),
    path('random-article/', article, name='article'),
